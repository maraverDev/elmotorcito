...
<div id="carouselExampleCaptions" class="carousel slide text-danger m-5">
  ...
  <h2 class="d-flex justify-content-center text-dark">Honda CBR-1000</h2>
    <div class="carousel-item active w-2-">
      <img src="/elmotorcito/images/carrousel-images/cbr-1000/10-honda-cbr1000rr-r-fireblade-2024-estudio-rojo-01.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/cbr-1000/10-honda-cbr1000rr-r-fireblade-2024-estudio-rojo-02.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/cbr-1000/honda-cbr1000rr-r-fireblade-2022-accion-01.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/cbr-1000/honda-cbr1000rr-r-fireblade-2022-accion-02.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/cbr-1000/honda-cbr1000rr-r-fireblade-2022-detalles-01.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
  </div>
