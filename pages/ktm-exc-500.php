...
<div id="carouselExampleCaptions" class="carousel slide text-danger m-5">
  ...
  <h2 class="d-flex justify-content-center text-dark">KTM EXC-500</h2>
    <div class="carousel-item active w-2-">
      <img src="/elmotorcito/images/carrousel-images/exc-500/01-ktm-500-exc-f-2024-estudio-01-739-a.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/exc-500/01-ktm-500-exc-f-2024-estudio-02.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/exc-500/01-ktm-500-exc-f-2024-estudio-07.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/exc-500/ktm-450-exc--f-2024-accion-01.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/exc-500/ktm-450-exc--f-2024-accion-02.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
  </div>
