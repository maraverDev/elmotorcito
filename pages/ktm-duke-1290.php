...
<div id="carouselExampleCaptions" class="carousel slide text-danger m-5">
  ...
  <h2 class="d-flex justify-content-center text-dark">KTM Duke-1290</h2>
    <div class="carousel-item active w-2-">
      <img src="/elmotorcito/images/carrousel-images/duke-1290/01-ktm-1290-super-duke-r-evo-2022-estudio-azul-01.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/duke-1290/01-ktm-1290-super-duke-r-evo-2022-estudio-azul-02.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/duke-1290/01-ktm-1290-super-duke-r-evo-2022-estudio-azul-03.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/duke-1290/01-ktm-1290-super-duke-r-evo-2022-estudio-azul-04.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/elmotorcito/images/carrousel-images/duke-1290/ktm-1290-super-duke-r-2022-accion-29.jpg" class="d-block w-50 m-auto" alt="...">
    </div>
  </div>
